...
MAX_JOBS=32 NVCC_THREADS=32 pip install -v . --index-url https://download.pytorch.org/whl/cu124 --extra-index-url https://mirrors.tuna.tsinghua.edu.cn/pypi/web/simple
```
